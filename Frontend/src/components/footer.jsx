...
//         <p className="text-sm">&copy; {new Date().getFullYear()} EduLearn. All rights reserved.</p>
...
const Footer = ({user}) => {
  // console.log("user for footer component",user);
    ...
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 py-6 border-t border-gray-300 dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex space-x-4 text-sm">
          ...
          {
            user===null || user._id === undefined ? null :
